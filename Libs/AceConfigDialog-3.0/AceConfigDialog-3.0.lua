...
-- @class file
-- @name Holyward-AceConfigDialog-3.0
-- @release $Id: AceConfigDialog-3.0.lua 1139 2016-07-03 07:43:51Z nevcairiel $

local LibStub = LibStub
local MAJOR, MINOR = "Holyward-AceConfigDialog-3.0", 63
...
local reg = LibStub("Holyward-AceConfigRegistry-3.0")
...
local function RefreshOnUpdate()
	-- Vanilla 1.12 frame scripts expose the frame through global `this`; they
	-- do not pass it as a function argument. Ace3v's local parameter shadowed
	-- that global and became nil.
	local frame = this
...
function AceConfigDialog:Open(appName, container, a1,a2,a3,a4,a5,a6,a7,a8,a9,a10)
	...
	-- Holyward's Vanilla options shell uses a ShaguTweaks-style dark pass (adapted
	-- from Questie-Octo's hook here). AceConfigDialog recreates child widgets on
	-- tab/options refresh, so reapply the theme after each Holyward feed without
	-- affecting other apps.
	if appName == "Holyward" and Holyward_ApplyOptionsDarkTheme then
