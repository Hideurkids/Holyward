...
-- @class file
-- @name Holyward-AceConfigRegistry-3.0
-- @release $Id: AceConfigRegistry-3.0.lua 1139 2016-07-03 07:43:51Z nevcairiel $
local MAJOR, MINOR = "Holyward-AceConfigRegistry-3.0", 16
...
local CallbackHandler = LibStub:GetLibrary("Holyward-CallbackHandler-1.0")
